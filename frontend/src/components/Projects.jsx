...
const Projects = () => {
  ...
  return (
    <section id="projects" className="bg-gray-50 py-8 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-serif font-bold text-gray-900 mb-3 sm:mb-4">Featured Projects</h2>
          <p className="text-gray-600 max-w-2xl mx-auto font-serif text-sm sm:text-base">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="text-gray-600 mb-3 sm:mb-4 font-serif text-sm sm:text-base">
                  {project.description}
                </p>
                <div className="mb-3 sm:mb-4">
                  <div className="flex flex-wrap gap-1 sm:gap-2">
                    {project.tech.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-2 sm:px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs sm:text-sm font-serif"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex space-x-3 sm:space-x-4">
                  {project.liveLink && (
                    <a
                      ...
                      className="flex items-center text-blue-500 hover:text-blue-600 font-serif text-sm sm:text-base"
                    >
                  ...
                  <a
                    ...
                    className="flex items-center text-gray-600 hover:text-gray-900 font-serif text-sm sm:text-base"
                  >
